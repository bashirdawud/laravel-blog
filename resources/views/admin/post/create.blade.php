            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group" @if($errors->has('title')) has->error @endif>
                        {!! Form::label('Title')!!}
                        {!! Form::text('title', null, ['class' => 'from-control', 'placeholder' => 'Title'])!!}
                        @if($errors->has('title'))
                  ...
                  <div class="form-group" @if($errors->has('sub_title')) has->error @endif>
                        ...
                        {!! Form::text('sub_title', null, ['class' => 'from-control', 'placeholder' => 'sub_title'])!!}
                   ...
                   <div class="form-group" @if($errors->has('details')) has->error @endif>
                        {!! Form::label('Details')!!}
                        {!! Form::text('details', null, ['class' => 'from-control', 'placeholder' => 'Details'])!!}
                  ...
                  <div class="form-group" @if($errors->has('category_id')) has->error @endif>
                        ...
                        {!! Form::text('category_id', null, ['class' => 'from-control', 'id' => 'category_id', 'multiple' => 'multiple'])!!}
                  ...
                  <div class="form-group">
                      {!! Form::label('Publish')!!}
                      {!! Form::select('is_published', [1 => 'Published', 0 => 'Draft'], null, ['class' => 'from-control'])!!}
